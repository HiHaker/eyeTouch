package com.yonyou.relation.dto;
...
public class SimpleSearchDTO {
    ...
    private static String PARAM_SEARCH_PREFIX = "search_";
        private String search_follows;     //关注人id

        public void setSearch_follows(String follows){
            this.search_follows = follows;
        }
        public String getSearch_follows(){
            return this.search_follows;
        }

        private String search_fans;     //粉丝id

        public void setSearch_fans(String fans){
            this.search_fans = fans;
        }
        public String getSearch_fans(){
            return this.search_fans;
        }
