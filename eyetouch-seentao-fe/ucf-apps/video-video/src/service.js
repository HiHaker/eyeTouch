...
//定义接口地址
const URL = {
    "GET_video": `${GROBAL_HTTP_CTX}` + '/video/video/list', // 获取主表
    "SAVE_video": `${GROBAL_HTTP_CTX}` + '/video/video/insertSelective', // 保存主表
    "UPDATE_video": `${GROBAL_HTTP_CTX}` + '/video/video/updateSelective', // 更新主表
    "DEL_video": `${GROBAL_HTTP_CTX}` + '/video/video/deleteBatch', // 删除主表
